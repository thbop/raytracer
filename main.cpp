...
int main() {
    ...
    auto material_glass  = make_shared<Dielectric>(1.33);

    world.add( make_shared<Sphere>(point3(0.5,0,-1), 0.5, material_blue) );
    world.add( make_shared<Sphere>(point3(-0.5,0,-1), 0.5, material_glass) );
    world.add( make_shared<Sphere>(point3(0,-1000.5,-1), 1000, material_mirror) );
